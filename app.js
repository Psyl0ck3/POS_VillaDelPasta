...
cottage_button.addEventListener('click', function() {
   ...
   orderDiv.innerHTML = `
       ...
       <div class="card-footer text-success">Quantity: ${quantity}</div>
...
burrata_button.addEventListener('click', function() {
   ...
   orderDiv.innerHTML = `
       <p>Burrata Bliss Ravioli Pasta: ₱${price}</p>
       <div class="card-footer text-right text-success">Quantity: ${quantity}</div>
